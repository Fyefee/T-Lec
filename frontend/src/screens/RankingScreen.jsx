  ...
  let [ranking, setRanking] = React.useState([
    {
      ...
      owner: "Jeffy",
      ownerImage:
        "https://lh3.googleusercontent.com/a/AATXAJwO0xmKV4E3ef4UvdkySmG1_eE8ApICu9TTRVzR=s96-c",
      LectureName: "Lec1",
      downloadCount: 159,
    },
    {
    ...
    >
      <NativeBaseProvider theme={theme}>
        <ScrollView style={styles.scrollView}>
          ...
          ></Image>
          <Image
            source={{ uri: ranking[0].ownerImage }}
            style={styles.ownerImage1}
            alt="1 Owner Image"
          />
          <Image
            source={{ uri: ranking[1].ownerImage }}
            style={styles.ownerImage2}
            alt="2 Owner Image"
          />
          <Image
            source={{ uri: ranking[2].ownerImage }}
